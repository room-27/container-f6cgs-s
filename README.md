...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-f6cgs-s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-f6cgs-s.containers.anotherwebservice.com/
...
```
git clone git@github.com:room-27/container-f6cgs-s.git
```
